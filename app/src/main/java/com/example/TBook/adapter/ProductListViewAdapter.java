...
public class ProductListViewAdapter extends BaseAdapter implements Filterable {
    private Context context;
    private ArrayList<Products> arrayList;
    private ArrayList<Products> temp;

    public ProductListViewAdapter(Context context, ArrayList<Products> arrayList) {
